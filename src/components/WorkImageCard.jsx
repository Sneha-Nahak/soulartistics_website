...
const WorkImageCard = ({imageArr}) => {
  return (
    <div className='gen-container'>
         <HashLink smooth to="/#mywork"><FaArrowCircleLeft />Go Back to My Work</HashLink>
       <div className='gen-content'>
         {imageArr.map((el,ind)=>(
           <>
           <img src={el} alt="image" key={ind} className='gen-img'/>
           </>
         ))}
       </div>
       <div className="bottom-btn-gen">
         
         <HashLink smooth to="#"><FaArrowCircleUp />Go to Top</HashLink>
       </div>
